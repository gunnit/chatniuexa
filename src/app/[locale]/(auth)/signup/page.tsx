        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-4 animate-slide-up" style={{ animationDelay: '200ms' }}>
            {[
              ...
              { icon: '💬', text: 'Train your chatbot on your data' },
              { icon: '📊', text: 'Analytics & insights dashboard' },
            ].map((feature, i) => (
      ...
      <div className="w-full lg:w-1/2 relative z-10 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-[420px] animate-scale-in">
          ...
          <div className="bg-white rounded-2xl border border-[#E4E4E7] p-8 sm:p-10 shadow-sm">
            {/* Header */}
            <div className="mb-8">
              <h1 className="font-serif text-2xl text-[#18181B] mb-2 tracking-[-0.01em]">{t('createAccount')}</h1>
              <p className="text-[#71717A] text-sm">{t('signupSubtitle')}</p>
            </div>
            ...
            <form action={formAction} className="space-y-5">
              ...
              <div className="space-y-4">
                {/* Full Name */}
                <div>
                  <label htmlFor="fullName" className="block text-sm font-medium text-[#3F3F46] mb-2">
                    {t('fullNameLabel')}
                  </label>
                ...
                {/* Password */}
                <div>
                  <label htmlFor="password" className="block text-sm font-medium text-[#3F3F46] mb-2">
                    {t('passwordLabel')}
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <p className="text-xs text-[#A1A1AA] text-center">
                {t('termsAgreement')}{' '}
                <Link href="/terms" className="text-[#0F766E] hover:text-[#0D6960]">{tc('termsOfService')}</Link>
                {' '}{t('and')}{' '}
                <Link href="/privacy" className="text-[#0F766E] hover:text-[#0D6960]">{tc('privacyPolicy')}</Link>
              </p>
            </form>
            ...
            <div className="text-center">
              <p className="text-[#71717A] text-sm">
                {t('hasAccount')}{' '}
                <Link href="/login" className="font-semibold text-[#0F766E] hover:text-[#0D6960] transition-colors">
                  {t('signInLink')}
                </Link>
              </p>
            </div>
