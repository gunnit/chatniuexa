    ...
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md animate-scale-in">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-white mb-2">{t('resetTitle')}</h1>
            <p className="text-slate-400">{t('resetSubtitle')}</p>
          </div>
          ...
          {state.success ? (
            <div className="text-center">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mb-6">
                ...
                <p className="text-sm text-emerald-300">{t('resetSuccess')}</p>
              </div>
              <Link
                href="/login"
