    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-slate-900">{t('createNew')}</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="col-span-full">
            <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl border border-slate-200/60">
              ...
              <p className="text-sm text-slate-500">{t('createFirst')}</p>
            </div>
          </div>
        ) : (
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-500">{chatbot._count.conversations} {t('conversations')}</p>
                  </div>
                </div>
