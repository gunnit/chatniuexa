...
export async function GET() {
  ...
  const lines: string[] = [
    '# ChatAziendale',
    '',
    '> AI chatbot builder for Italian SMBs and businesses worldwide. Train chatbots on your documents, websites, and FAQs — they answer customer questions with source citations, no hallucinations. Free plan available, WhatsApp Business integration on paid plans.',
    '',
    '## About',
    '',
    `- [Homepage](${BASE_URL}/): Product overview and pricing`,
    ...
    '## Pricing',
    '',
    '- **Free**: 1 chatbot, 50 messages/month, basic analytics',
    '- **Pro ($29/mo)**: 5 chatbots, 2,000 messages/month, full analytics, website crawling, WhatsApp integration',
    '- **Business ($149/mo)**: Unlimited chatbots, 10M tokens/month, priority support, all integrations',
    '',
    '## Articles',
    '',
  ]
