    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-8">
          ...
          <h1 className="text-xl font-bold text-slate-900 mb-2">Activating your subscription...</h1>
          <p className="text-slate-500">Please wait while we confirm your payment with PayPal.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-2xl border border-red-200 shadow-sm p-8">
          ...
          <p className="text-slate-500 mb-6">{error || 'There was an issue activating your subscription.'}</p>
          <Link
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-16 text-center">
      <div className="bg-white rounded-2xl border border-emerald-200 shadow-sm p-8">
        ...
        <h1 className="text-xl font-bold text-slate-900 mb-2">Subscription Activated!</h1>
        <p className="text-slate-500 mb-2">
          Welcome to the <span className="font-semibold capitalize">{plan}</span> plan.
        </p>
        <p className="text-sm text-slate-400 mb-6">
          Your new limits are now active. It may take a moment for everything to update.
        </p>
