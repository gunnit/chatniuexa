        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6">
            ...
            <ol className="space-y-3">
              {[
                { text: 'Add your data sources (files or URLs)', done: dataSourceCount > 0 },
                { text: 'Create a chatbot', done: chatbotCount > 0 },
                { text: 'Configure your chatbot settings', done: false },
                { text: 'Test your chatbot in the dashboard', done: false },
                { text: 'Copy the embed code to your website', done: false },
              ].map((step, index) => (
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 h-full">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-slate-900">Recent Chatbots</h2>
              <Link
                href="/dashboard/chatbots"
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500">
                          {chatbot._count.conversations} conversations
                        </p>
                      </div>
                    </div>
